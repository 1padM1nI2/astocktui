...
import { htmlToParagraphs, loadArticleText, type ArticleFetcher } from "../src/news-article"
...
test("其他网页退化为中文段落启发式提取", async () => {
  ...
  const paragraphs = await loadArticleText(itemWith("https://example.com/news/1"), fetcherReturning(page))
