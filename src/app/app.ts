...
import { AgentEventDispatcher } from "../agent/agent-event-dispatcher"
import { AgentExtensionRuntime } from "../agent/agent-extensions"
import { AgentScrollState } from "../agent/agent-scroll"
import { MemoryService } from "../agent/memory-service"
import { createPiAgentController } from "../agent/pi-agent"
import { runResearchTask } from "../agent/research-agent"
import { createScheduledTaskSink } from "../agent/research-task-runner"
import { buildCommandContext } from "../commands/app-command-context"
import { CommandPrompt } from "../commands/command-prompt"
import {
  type CommandContext,
  executeCommand,
  type RefreshReport,
...
} from "../market/cached-sources"
import { fetchHotRank, type HotRankFetcher } from "../market/eastmoney-hot-rank"
import type { MarketDataSource } from "../market/market-data"
import { type MarketOverviewDataSource, MarketOverviewService } from "../market/market-overview"
import { PublicMarketOverviewDataSource } from "../market/market-overview-source"
